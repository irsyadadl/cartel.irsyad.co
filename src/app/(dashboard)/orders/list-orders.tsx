              ...
              <TableCell className="text-end">
                <Menu>
                  ...
                  <MenuContent placement="left top" className="min-w-56">
                    <MenuItem href={`/orders/${item.id}`}>
                      <IdentificationIcon />
                      <MenuLabel>View order</MenuLabel>
                    </MenuItem>
                    <MenuItem href={`/customers/${item.customer_id}`}>
                      <UserIcon />
                    ...
                    <MenuItem href={`/orders/${item.id}/invoice`}>
                      <PrinterIcon />
                      <MenuLabel>Download invoice</MenuLabel>
                    </MenuItem>
                    <MenuItem href={`/orders/${item.id}/packing-slip`}>
                      <DocumentTextIcon />
                      <MenuLabel>Print packing slip</MenuLabel>
                    </MenuItem>
                    <MenuItem href={`/orders/${item.id}/resend-receipt`}>
                      <EnvelopeIcon />
                    ...
                    {item.status === "authorized" && (
                      <MenuItem href={`/orders/${item.id}/payment/capture`}>
                        <CreditCardIcon />
                    ...
                    {item.status === "paid" ? (
                      <>
                        <MenuItem href={`/orders/${item.id}/refund`}>
                          <ArrowUturnLeftIcon />
                          <MenuLabel>Refund</MenuLabel>
                        </MenuItem>
                        <MenuItem href={`/orders/${item.id}/payment/mark-unpaid`}>
                          <XCircleIcon />
                      ...
                      <>
                        <MenuItem href={`/orders/${item.id}/payment/mark-paid`}>
                          <BanknotesIcon />
                          <MenuLabel>Mark as paid</MenuLabel>
                        </MenuItem>
                        <MenuItem href={`/orders/${item.id}/payment/send-link`}>
                          <LinkIcon />
                    ...
                    <MenuItem href={`/orders/${item.id}/tracking`}>
                      <QueueListIcon />
                    ...
                    {item.status === "canceled" ? (
                      <MenuItem href={`/orders/${item.id}/reopen`}>
                        <ArrowPathRoundedSquareIcon />
                        <MenuLabel>Reopen order</MenuLabel>
                      </MenuItem>
                    ) : (
                      <MenuItem href={`/orders/${item.id}/cancel`}>
                        <NoSymbolIcon />
                        <MenuLabel>Cancel order</MenuLabel>
                      </MenuItem>
                    )}

                    <MenuItem href={`/orders/${item.id}/archive`}>
                      <ArchiveBoxIcon />
                      <MenuLabel>Archive order</MenuLabel>
                    </MenuItem>
                    <MenuItem isDanger href={`/orders/${item.id}/delete`}>
                      <TrashIcon />
