    ...
    return (
      <>
        ...
        <Sheet isOpen={open} onOpenChange={setOpen} {...props}>
          <SheetContent side={side} aria-label="Mobile Navbar" className="[&>button]:hidden">
    ...
    >
      <div
        className={twMerge(
          ...
          intent === "float" &&
            "rounded-xl bg-bg *:data-[navbar=content]:max-w-7xl *:data-[navbar=content]:rounded-xl *:data-[navbar=content]:border *:data-[navbar=content]:bg-navbar *:data-[navbar=content]:px-4 *:data-[navbar=content]:shadow-xs",
          ...
          {(isCurrent || values.isCurrent) && (
            <span
              ...
              className={twJoin(
                ...
                "md:-bottom-2.5 md:inset-x-2 md:h-(--gutter)",
              )}
            />
          )}
        </>
