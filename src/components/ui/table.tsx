  ...
  <TableBodyPrimitive
    ...
    renderEmptyState={() => (
      <div aria-hidden className="relative flex h-72 items-center justify-center md:h-100">
        <div
          aria-hidden
          className="-translate-y-1/2 absolute top-1/2 m-auto grid size-15 place-content-center rounded-full border border-border/50 md:size-20"
        >
          <svg
            aria-hidden
          ...
          <svg
            aria-hidden
            xmlns="http://www.w3.org/2000/svg"
            className="-top-20 absolute size-5 text-muted-fg/50"
            viewBox="0 0 24 24"
            fill="none"
          >
            <path
          ...
          <svg
            aria-hidden
            xmlns="http://www.w3.org/2000/svg"
            className="-left-10 absolute top-0 size-5 text-muted-fg/80"
            viewBox="0 0 24 24"
            fill="none"
          >
            <path
          ...
          <svg
            aria-hidden
            xmlns="http://www.w3.org/2000/svg"
            className="-left-20 absolute top-16 size-5 text-muted-fg/70"
            viewBox="0 0 24 24"
            fill="none"
          >
            <path
          ...
          <svg
            aria-hidden
            xmlns="http://www.w3.org/2000/svg"
            className="-right-24 absolute top-16 size-5 text-muted-fg/50"
            viewBox="0 0 24 24"
            fill="none"
          >
            <path d="M8.5 13.5H12.5M8.5 17.5H15.5" stroke="currentColor" strokeLinecap="round" />
            <path
          ...
          <svg
            aria-hidden
            xmlns="http://www.w3.org/2000/svg"
            className="-top-0 absolute left-24 size-5 text-muted-fg/80"
            viewBox="0 0 24 24"
            fill="none"
          >
            <path
          ...
          <svg
            aria-hidden
            xmlns="http://www.w3.org/2000/svg"
            className="-right-20 -top-20 absolute size-5 text-muted-fg/80"
            viewBox="0 0 24 24"
            fill="none"
          >
            <path
          ...
          <svg
            aria-hidden
            xmlns="http://www.w3.org/2000/svg"
            className="-top-10 -left-20 absolute size-5 text-muted-fg/50"
            viewBox="0 0 24 24"
            fill="none"
          >
            <path
        ...
        <i
          className="-translate-y-1/2 absolute top-1/2 m-auto size-30 rounded-full border border-border/40 md:size-40"
          aria-hidden
        />
        <i
          className="-translate-y-1/2 absolute top-1/2 m-auto size-45 rounded-full border border-border/30 md:size-60"
          aria-hidden
        />
        <i
          className="-translate-y-1/2 absolute top-1/2 m-auto size-60 rounded-full border border-border/20 md:size-80"
          aria-hidden
        />
        <i
          className="-translate-y-1/2 absolute top-1/2 m-auto size-80 rounded-full border border-border/10 md:size-100"
          aria-hidden
        />
...
const TableRow = <T extends object>({
  ...
  const { striped, bleed } = useTableContext()
  return (
    <Row
      ref={ref}
      data-slot="table-row"
