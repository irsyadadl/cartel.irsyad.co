  ...
  return (
    <Button
      className={cx(className, [
        ...
        "group-open/select:inset-ring-ring/70 group-open/select:ring-3 group-open/select:ring-ring/20 group-open/select:hover:inset-ring-ring/70",
        ...
        <>
          ...
          {!children && (
            <>
              ...
              <ChevronUpDownIcon
                data-slot="chevron"
                className="-mr-1 size-4 shrink-0 text-muted-fg group-open/select:text-fg group-disabled/select:opacity-50 sm:mr-0"
              />
            </>
          )}
        </>
