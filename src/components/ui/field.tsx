...
const fieldStyles = tv({
  slots: {
    ...
    description: "text-muted-fg text-sm/6 group-disabled:opacity-50",
    fieldError: "text-danger text-sm/6 group-disabled:opacity-50 forced-colors:text-[Mark]",
  },
})
  ...
  return (
    <Group
      ...
      className={cx(className, [
        ...
        "*:[button]:rounded-[calc(var(--radius-lg)-3px)] *:[button]:px-(--gutter-x) *:[button]:py-[calc(--spacing(1)-1px)]",
        "*:[button]:first:ml-[--spacing(1.2)] *:[button]:last:mr-[--spacing(1.2)] sm:*:[button]:last:mr-[--spacing(0.7)] sm:*:[button]:first:ml-[--spacing(0.7)]",
        "hover:inset-ring-muted-fg/30 focus-within:hover:inset-ring-ring/70 has-invalid:hover:inset-ring-danger/70",
