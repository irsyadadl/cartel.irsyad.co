...
const Checkbox = ({ className, children, description, label, ...props }: CheckboxProps) => {
  return (
    <CheckboxPrimitive {...props} className={cx(className, "group block disabled:opacity-50")}>
      {composeRenderProps(
        children,
          ...
          return (
            ...
            >
              <span
                data-slot="indicator"
                className={twMerge([
                  "relative inset-ring inset-ring-input isolate flex shrink-0 items-center justify-center rounded bg-muted text-bg transition group-hover:inset-ring-muted-fg/30",
